...
const styles = StyleSheet.create({
  ...
  filtresText: { color: COLORS.text, fontSize: 14, fontFamily: FONTS.extraBold, letterSpacing: 0.6 },
  ...
  radioLabel: { color: COLORS.text, fontSize: 15, fontFamily: FONTS.regular },
  ...
  applyText: { color: COLORS.text, fontSize: 13, fontFamily: FONTS.extraBold, letterSpacing: 0.5 },
});
