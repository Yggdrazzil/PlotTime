...
const styles = StyleSheet.create({
  ...
  thumb: { width: 96, backgroundColor: COLORS.imagePlaceholder, alignItems: 'center', justifyContent: 'center' },
  ...
  code: { color: COLORS.text, fontSize: 20, fontFamily: FONTS.bold },
  epTitle: { color: COLORS.text, fontFamily: FONTS.regular, fontSize: 13 },
